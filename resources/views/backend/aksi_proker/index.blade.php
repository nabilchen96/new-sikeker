            ...
            <form id="form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_rencana_proker" id="id_rencana_proker2">
                            ...
                            <option value="{{ $item->id }}">{{ $item->rencana_proker }} [ Unit:
                                {{ $item->unit }} ] {{ $item->status_rencana == 'Selesai' ? ' ✅ Selesai' : '' }} </option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="kegiatan_proker" id="kegiatan_proker" cols="10" rows="10" required
                            class="form-control" placeholder="Jelaskan Kegiatan Proker"></textarea>
                    </div>
