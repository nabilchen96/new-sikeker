...
<div id="laporan-pdf">
    ...
    @foreach ($data as $unitProkers)
        <table>
            <thead>
                <tr>
                    <th style="text-align: left;" colspan="5" width="100%">
            ...
            <thead>
                <tr>
                    <th width="25%">Rencana Proker</th>
                    <th width="15%">Jenis Proker</th>
                    <th width="20%">Waktu Pengerjaan</th>
                    <th width="8%">Status Proker</th>
                    <th width="30%">Kegiatan Proker</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($unitProkers as $item)
                    <tr>
                        ...
                        <td align="center">
                            {{ $item->status_rencana ?? 'Belum' }}
                        </td>
                        <td>
                            {{ $item->kegiatan_proker }}
                        </td>
                    </tr>
                @endforeach
            </tbody>
