...
<body>
    ...
    <div class="d-lg-flex half">
        <div class="bg order-1 order-md-2" style="background-image: url('https://i.ytimg.com/vi/lBQKYJ3PRHU/maxresdefault.jpg');"></div>
        <div class="contents order-2 order-md-1">

            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-7">
                        <h3>Login to <br><strong>Sikeker Poltekbang <br> Palembang</strong></h3>
                        <br>
                        <form id="formLogin">
